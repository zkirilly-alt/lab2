...
TEST(ArraySequenceTest, ConstructorFromArray) {
    int data[] = {1, 2, 3, 4, 5};
...
TEST(ArraySequenceTest, GetSubsequenceThrowsOnInvalidIndices) {
    int data[] = {1, 2, 3};
...
TEST(ArraySequenceTest, GetThrowsOnInvalidIndex) {
    int data[] = {1, 2, 3};
    ArraySequence<int> seq(data, 3);
